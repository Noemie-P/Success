<template>
    <div class="QCM">
        ...
        <!--<div v-bind="question" class="form-check" v-cloak v-for="v in question.question_answers" :key="v.id">
            <input :id="v.id" :value="v.answer_name" v-model="answer" class="form-check-input" type="radio" name="formCheck-1">
            <label :id="v.id" class="form-check-label" for="formCheck-1">{{ v.answer_name }}</label>
        </div>-->
